...
The relevant reader material and catalogue can establish the context for a checklist such as [Security in Transit](../shared/reference/checklists/security-in-transit.md), [Deliverables](../shared/reference/checklists/deliverables.md) or [Sites and Interfaces](../shared/reference/checklists/sites-and-interfaces.md). The answers belong with the service's requirements, decisions, tests and evidence.
