...
Compact instructions that tell an AI agent what rules apply to a task. Agent guidance should be precise and task-selective. It links to accessible explanations rather than copying them.
...
See [Developer Families](./catalogues/stakeholder-roles.md#developer-families) and [Developer Guidance](../../stakeholders/deliverers/developers/readme.md).
...
See [Testing Evidence and Boundaries](../../stakeholders/deliverers/testers/evidence-and-boundaries.md#test-suite).
...
See [BUST Requirements](../../stakeholders/deliverers/business-analysts/bust-requirements.md).
...
A web service can therefore be **part of** an organisational digital solution while also **running on** an operating-system and infrastructure stack. Part of describes a design or business relationship. Runs on describes a technical execution relationship.
...
Explanations written for people from different roles and levels of technical experience. Reader guidance explains the problem and concept before the technical term.

See [Engineering for People](./readme.md).
