...
- [ ] Pipeline and workload identities retrieve secret values only when required, while people are prevented from retrieving or copying production secret values.
