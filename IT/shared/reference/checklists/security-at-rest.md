...
## Keep secret values out of people's hands
...
- [ ] Are people prevented from retrieving or copying production secret values? Administrators may manage permissions, rotation, expiry and metadata without reading the values.
