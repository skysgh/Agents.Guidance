...
The catalogues are the shared reference layer inside wider reader material. [Delivery](../../../deliverables/readme.md) explains how systems, material, responsibilities and evidence become one delivered outcome; the catalogues give names and boundaries to the parts of that outcome. [Shared Concerns](../readme.md) keeps the wider explanation, examples, roles and consequences nearby.
