...
A responsibility is not a job description and it does not make a role the owner of every subject it touches. Shared concepts remain in [Shared Concerns](../shared/readme.md). Each stakeholder perspective explains how that role enters the shared material, what it contributes, what it decides, what it produces, what it needs from other roles and where its responsibility ends.
...
Product Manager and Product Owner responsibilities often overlap, but should be distinguished by the kind of value and time horizon they steward rather than by title. A Product Manager is a far-seeing product steward: they connect purpose, users, value, viability, strategic fit, investment and longer-term outcomes to the real constraints of budget, schedule, organisational capacity, obligations and risk. They help the organisation choose objectives it can responsibly pursue, not merely objectives that sound desirable.

A Product Owner turns that direction into an informed and achievable path. They convene the people who can make elicitation complete, help the relevant authorities resolve meaning and trade-offs, and arrange the outcomes, foundations and evidence that should be delivered next. The Product Manager asks whether the organisation is pursuing the right objectives within its constraints; the Product Owner arranges the outcomes and enabling work that make those objectives real. One person may perform both responsibilities; the decision record should still say which authority and time horizon is being exercised.

Scrum has a Scrum Master accountability. Kanban does not require a Scrum Master; a team may assign a flow facilitator, delivery manager or service delivery manager to help with flow, policies, blockers, feedback and improvement. If no one is assigned, the responsibility is an explicit delivery gap or must be assigned by the team or sponsor. It should not silently become the architect's, Product Owner's or most senior developer's work.
...
- quality, transitional and operational requirements;
...
- [Shared Concerns](../shared/readme.md)
