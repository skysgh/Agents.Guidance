...
- [Service Accountability and Deliverables](./service-accountability-and-deliverables.md): make the service promise, role ownership and Support, Operational and Maintenance information visible.

## The Service Provider's responsibility

A Service Provider makes sure that the service has an accountable owner, a defined consumer promise, suitable people and boundaries, required evidence, support arrangements, operational controls, maintenance capacity and a route for change or retirement. The Service Provider ensures that gaps are visible and assigned; it does not erase specialist authority by absorbing every decision.

The Service Provider defines whether the service uses Tier 0 self-service, Tier 1 people-facing Support, Tier 2 Service Provider or Operations investigation and Tier 3 Maintenance Developer or infrastructure-maintenance investigation. The labels may differ, but the provider must make the first contact, escalation depth, authority, evidence and return-to-user path unambiguous.
