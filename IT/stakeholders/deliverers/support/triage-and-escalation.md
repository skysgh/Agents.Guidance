...
Support is the first point of contact for end users. The first task is not to guess the technical cause. It is to understand the report well enough to help the person, protect their information and send the right evidence to the responsible boundary.
...
- **Tier 1 Support:** the first person-to-person contact records the report, confirms the relevant context, applies documented safe responses and remains responsible for communication with the person.
