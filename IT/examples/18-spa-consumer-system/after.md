...
The client coordinates the user journey without becoming the authority for the business decision:
...
The first version treated the SPA as presentation furniture and allowed the browser to carry hidden authority. The improved version gives the client its own system boundary, component vocabulary, quality-in-use responsibilities, security controls and evidence path while preserving the service as the authority for business meaning and durable outcomes.
