...
The registry route is the reader story and decision path. The [Registries catalogue](../../shared/reference/catalogues/registries.md) remains the canonical explanation of registry types and the minimum registry contract. Project teams must still create only the registries their own consequences require.
