...
These responsibilities are architectural rather than necessarily separate projects or deployments. They keep the conceptual meaning, logical model and physical representation from being confused. The [Logical Layers](../../../shared/reference/catalogues/logical-layers.md) catalogue explains the implementation areas, while [Conceptual, Logical and Physical Models](../../../shared/reference/catalogues/conceptual-logical-physical-models.md) explains the model types. The areas contain contracts, constants, models, services, registries, repositories, interfaces and implementations as appropriate.

When a new type needs a home, [Logical Deployment Modules](../../../shared/reference/catalogues/ldms.md), [Logical Layers](../../../shared/reference/catalogues/logical-layers.md) and [Logical Building Blocks](../../../shared/reference/catalogues/logical-building-blocks.md) explain the structures that make that decision clearer. They are reference points to return to when the responsibility is uncertain, not a reading gate before useful work can begin.
...
- [Systems Within Systems](../../../foundations/systems-within-systems.md)
