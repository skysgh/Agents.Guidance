...
The [System LDM Service Readiness Reference](../../../shared/reference/platform-services.md) gives the detailed purpose and readiness question for each service. Use it when a team needs to decide whether a framework capability is sufficient or whether an application-owned contract and boundary are still required.
