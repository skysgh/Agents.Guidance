...
The service is not the client, delivery pipeline or testing system. A browser may present a request and coordinate a user journey, but the service validates permissions, owns business rules, controls durable state and records consequential outcomes.

## Service implementation guidance

The detailed service-system material is currently staged in [Development Guidance](../../../development/readme.md). Its pages are being classified before relocation because the current Development folder contains service-specific material alongside concepts that cross client and service boundaries.
...
- [Deliverable Systems](../../../shared/reference/catalogues/deliverable-systems.md#2-service-system)
- [Guidance for Developers](../../../foundations/guidance-for-developers.md)
- [Technical Lead Guidance](../../../stakeholders/deliverers/technical-leads/readme.md)
