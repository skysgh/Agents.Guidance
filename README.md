...
- [Where can I find a short, story-led way into the guidance?](./IT/foundations/ways-into-guidance.md)
- [How does the shared guidance fit together?](./IT/readme.md)
- [What belongs in a usable and supportable delivered outcome?](./IT/deliverables/readme.md)
- [What problem or role feels closest to my work?](./IT/examples/readme.md)
...
## People-first entry point

This repository is primarily written for people. The [reader material](./IT/readme.md) explains meaning, consequences, roles, examples and routes through the work.

Agents should use the [agent conventions](./agents/readme.md) when they need a denser, more task-selective expression of the same engineering intent. It contains less explanation and is designed to consume fewer tokens during delivery work. When a convention is unclear or its reason matters, follow its link back to the reader material.

The two expressions should agree. Reader pages explain why a rule matters and show how it appears in a real situation. Agent conventions make the rule easy to apply consistently during delivery work.
...
The [foundations](./IT/foundations/readme.md), [deliverables](./IT/deliverables/readme.md), [system perspectives](./IT/deliverables/systems/readme.md), [stakeholder responsibilities](./IT/stakeholders/readme.md), [examples](./IT/examples/readme.md) and [reference material](./IT/shared/reference/readme.md) provide the detailed paths.
...
Repository assessments, audits, plans and handovers are kept under [.agent-work](./.agent-work/), separate from the published reader and agent guidance.
