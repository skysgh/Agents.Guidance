...
For the accessible explanation of slices and their relationship to the flow palette, read [Common Flows](../../../humans/orientation/flows.md), [Deliverable Systems](../../../humans/shared/reference/catalogues/deliverable-systems.md), [Deliverables](../../../humans/shared/reference/catalogues/deliverables.md) and [First Look at the Client Experience](../../../humans/delivery/systems/client/first-look.md).
