...
Every Markdown page must provide a predictable way back to the nearest broader context:
...
Use a labelled relative Markdown link at the end of the document, after related links. This is a navigation aid, not a reading-order command. Keep the page understandable without requiring the reader to follow the parent link first.

[Up: Documentation Conventions](./readme.md)