...
Agents must use this inventory when planning a new capability, module, service, endpoint, persistence model or cross-cutting integration. The accessible explanation is [Guidance for Tech Leads](../../../IT/foundations/guidance-for-tech-leads.md), and the detailed reader reference is [Platform Services Reference](../../../IT/shared/reference/platform-services.md).
...
Use the [Platform Services Reference](../../../IT/shared/reference/platform-services.md) for the purpose and readiness questions of each item.
