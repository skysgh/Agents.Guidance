...
For the accessible explanation of the package boundary, read [Logical Deployment Modules](../../../humans/shared/reference/catalogues/ldms.md), [LDM Layers and Contents](../../../humans/development/layers.md) and [Guidance for System Design Architects](../../../humans/orientation/guidance-for-system-design-architects.md).
