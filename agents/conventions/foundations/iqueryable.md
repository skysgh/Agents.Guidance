...
For the accessible explanation and examples, read [First Look at the Client Experience](../../../IT/deliverables/systems/client/first-look.md) and [IQueryable guidance in the current-state examples](../../../IT/foundations/current-state.md).
