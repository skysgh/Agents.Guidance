...
This document follows [The Palette: First Look](./PALETTE-FIRST-LOOK.md). It explains the job of each element before explaining how the elements connect.
...
When these element jobs are familiar, continue to [Palette Relationships](./PALETTE-RELATIONSHIPS.md).
