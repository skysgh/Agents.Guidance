...
This document is optional technical detail. Start with [The Palette: First Look](./PALETTE-FIRST-LOOK.md) if the terms are new.
...
- [Portable horizontal flow rules](../conventions/flows.md)
