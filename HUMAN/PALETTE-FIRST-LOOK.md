...
- [Palette Elements](./PALETTE-ELEMENTS.md) explains the job of each part.
- [Palette Relationships](./PALETTE-RELATIONSHIPS.md) explains how the parts connect.
...
- [Palette and Presenter/Player/Coordinator terms](./PALETTE-TECHNICAL-TERMS.md) explains the frontend vocabulary.
