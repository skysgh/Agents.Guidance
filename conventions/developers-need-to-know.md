...
For worked recognition rather than more explanation, use the [example gallery](../examples/README.md). Choose the case that resembles the problem in front of you, read the `before.md` account, then read the matching `after.md` account.
