...
The binding document should be loaded for code work and should link back to this repository's `AGENTS.md`. It should map, in a compact table or short sections:
