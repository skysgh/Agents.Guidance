...
**Related guidance:** [Startup and discovery](./startup.md), [Data protection](./data-protection.md), [Vertical slices](./slices.md), [Horizontal flows](./flows.md), and [IQueryable and governed queryability](./iqueryable.md).
