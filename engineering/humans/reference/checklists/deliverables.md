...
- [ ] Have the applicable deliverable systems been identified: delivery, service, consumer and testing?
- [ ] Is each deliverable assigned an owner, operator or responsible external team?
...
- [ ] Does the shared context have stable scenario identifiers, ownership, versioning, contribution rules, translators, generated representations and expected outcomes?
...
- [ ] Is the domain name registered to the correct owner with renewal and recovery controls?
...
- [ ] Are the owners, contracts, publication process, update timing and failure behaviour of those corporate surfaces known?

## Delivery and operations

- [ ] Are source, packages, images, bundles, infrastructure definitions, deployment configuration and migrations versioned and traceable?
...
- [ ] Are access policies, identity registrations, secret-store bindings and certificate ownership delivered without copying secret values into ordinary configuration?
