...
The maintenance site is for people who change, repair or administer the technical service. It may expose controlled configuration, diagnostics, migrations, discovery, dependency checks, deployment information or recovery actions. Maintenance capabilities are particularly sensitive because they can change the conditions under which other sites operate. They should be curated for the maintenance responsibility and protected by the system’s security controls, not merely hidden from ordinary navigation.
