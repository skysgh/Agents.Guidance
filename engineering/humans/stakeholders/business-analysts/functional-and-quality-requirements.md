...
Avoid relying on words such as “manage”, “handle”, “process” or “support” without describing the responsibility beneath them. A concise requirement is valuable when the omitted detail is genuinely private implementation detail. It is incomplete when the omitted detail determines authority, lifecycle, history, safety or evidence.
...
- “The system shall be user-friendly” without users, context, consequence or evidence.
- “The API shall return all fields” without classification, purpose, consumer or minimisation.
- “The page shall load quickly” without workload, subject, target or measurement.
- “The application shall be secure” without protected resources, actors, permissions, threat or control evidence.
- “The data shall be retained” without purpose, authority, period, access, disposal and record status.
- “The system shall be scalable” without demand, growth, failure boundary, cost and operational target.
- “The user can edit the record” without state, authority, history, concurrency and audit rules.
