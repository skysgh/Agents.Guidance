...
For example, “add online applications” is a feature direction. “An eligible applicant can submit a complete application, receive an understandable acknowledgement and later see the authoritative status without contacting support” is an outcome direction. It still needs domain, policy, security, accessibility, operational and evidence analysis before it is a buildable requirement.
