...
For the accessible explanation and examples, read [The Palette: First Look](../../../humans/palette/first-look.md) and [IQueryable guidance in the current-state examples](../../../humans/orientation/current-state.md).
