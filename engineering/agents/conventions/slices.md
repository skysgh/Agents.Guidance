...
For the accessible explanation of slices and their relationship to the flow palette, read [Common Flows](../../humans/flows.md) and [Palette First Look](../../humans/palette/first-look.md).

Before naming a slice, identify the Domain that gives the capability its meaning and the Functions that belong within it. The human [Guidance Glossary](../../humans/glossary.md) explains these terms and the risk of polysemy.
