...
For the human explanation of the View, Coordinator, Presenter, Player, Renderer, Action, State, Event and Broker relationships, read [Common Flows](../../humans/flows.md). This document keeps the portable implementation rules and lifecycle constraints.

When flow names are ambiguous across problem areas, read the human [Guidance Glossary](../../humans/glossary.md) entry on polysemy, Domains, Capabilities and Functions before creating a new term.
...
The following sections provide additional implementation detail. Human readers can stop after the catalogue and use the [human flow guide](../../humans/flows.md) and [Request example](../../humans/examples/10-request-bread-flow/before.md) instead.
