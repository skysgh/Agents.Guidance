...
For the human-facing writing contract, apply [Human Documentation Writing Style](../../humans/writing-style.md). It requires concept-first explanations, plain and translation-friendly language, consistent terminology, role-inclusive examples and a clear separation between human explanation and compact agent rules.
