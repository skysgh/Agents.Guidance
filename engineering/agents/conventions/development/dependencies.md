...
For the accessible explanation of dependencies as organisational commitments, read [The Current State](../../../humans/orientation/current-state.md) and [Vendor Material and Engineering Competence](../../../humans/orientation/vendor-material-and-engineering-competence.md).
...
See [Technology Registries](./registries.md) and the human explanation in [Vendor Material and Engineering Competence](../../../humans/orientation/vendor-material-and-engineering-competence.md).
