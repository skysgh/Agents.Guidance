...
Agents must use this inventory when planning a new capability, module, service, endpoint, persistence model or cross-cutting integration. The human explanation is [What Tech Leads Need to Know](../../../humans/orientation/tech-leads-need-to-know.md), and the detailed human reference is [Platform Services Reference](../../../humans/reference/platform-services.md).
