...
For the human explanation of why published contracts need a managed life, read [API Lifecycle](../../../humans/orientation/api-lifecycle.md). This document states the precise portable rules.
