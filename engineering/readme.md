...
This repository is aimed at serious systems: systems whose failure can materially affect an organisation's reputation, money, legal position, entrusted information, essential services or public trust. For those systems, domains, capabilities, LDMs, layers, contracts, vertical slices, multiple deliverable systems, checklists and formal evidence are not optional decoration. Before treating a service as delivered, use [Deliverable Systems](./humans/reference/catalogues/deliverable-systems.md) to identify the distinct delivery, service, consumer, testing and cross-system test-context systems. Use [Deliverables](./humans/reference/catalogues/deliverables.md) to identify the data, content, addressing, discovery, dependencies, operational material and evidence that must exist around them.
