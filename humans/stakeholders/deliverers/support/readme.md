...
- **Tier 1:** the first human point of contact, usually a service desk or customer-support team. Tier 1 receives the user's report, confirms identity and context as appropriate, records the symptom and impact, applies documented safe responses and communicates with the user.
