...
Return to concrete software terms once the relationship is clear. The [Human Documentation Writing Style](../../../.agent-work/documentation/writing-style.md) explains how to introduce and use the metaphor in other human-facing documents.
