...
This folder gathers the named structures that recur across the delivery guidance. A catalogue is a teaching document as well as a reference. It gives a subject enough shape that a reader can recognise it, understand why it exists and see how it relates to the other structures around it.

The catalogues are the shared reference layer inside a wider human route. [Delivery Guidance](../../../delivery/readme.md) explains how systems, material, responsibilities and evidence become one delivered outcome; this folder gives names and boundaries to the parts of that outcome. The [Human Guidance](../readme.md) keeps the wider explanation, examples, roles and consequences nearby.
...
The companion [checklists](../checklists/readme.md) turn the explanations into prompts for design and review. The documents explain the reasoning; the checklists help a team remember to apply it. When a catalogue question broadens into the whole delivered outcome, return to [Delivery Guidance](../../../delivery/readme.md) or the [Human Guidance](../readme.md) rather than treating the catalogue as a separate world.
