[Up: Shared Reference](../readme.md)

# Engineering Catalogues

This collection gathers the named structures that recur across delivery work. A catalogue is a teaching document as well as a reference. It gives a subject enough shape that a reader can recognise it, understand why it exists and see how it relates to the other structures around it.

The catalogues are the shared reference layer inside wider human material. [Delivery](../../../deliverables/readme.md) explains how systems, material, responsibilities and evidence become one delivered outcome; the catalogues give names and boundaries to the parts of that outcome. [Shared Human Concerns](../readme.md) keeps the wider explanation, examples, roles and consequences nearby.
...
There is no required first catalogue. A question about people or authority may fit [Stakeholder Roles](./stakeholder-roles.md), [Users to Consider](./users.md) or [System Roles](./system-roles.md). A question about delivery may fit [Deliverable Systems](./deliverable-systems.md), [Deliverables](./deliverables.md) or [Registries](./registries.md). A question about implementation may fit the model, LDM, layer or capability catalogues. Each catalogue names related subjects so a reader can widen or narrow the question without losing the wider delivery context.

The catalogues can be read at different levels of detail. Stakeholder Roles and Users to Consider keep people, authority and affected perspectives visible. Regulatory and Obligation Domains and Quality Perspectives connect duties and qualities to evidence. Conceptual, Logical and Physical Models, Sites, flows, domains and capabilities give meaning and audience a clearer shape. Logical deployment modules, layers and building blocks then place implementation responsibility, while patterns and storage types help name recurring physical responses. The subjects are connected, but the useful starting point depends on the question in front of the reader.

The detailed catalogue path depends on the question in front of you. [Stakeholder Roles](./stakeholder-roles.md) and [Regulatory and Obligation Domains](./regulatory-obligations.md) help place authority, evidence and external duties. [Conceptual, Logical and Physical Models](./conceptual-logical-physical-models.md) and [Sites](./sites.md) help give meaning and audience a clearer shape. When the experience needs more detail, [Sites, Flows, Views and Components](./sites-flows-views-components.md) and the client-system [UX Palette](../../../deliverables/systems/client/ux-palette.md) follow that thread. [Registries](./registries.md) distinguishes enterprise-referred sources of options and constraints from project-produced records of actual dependencies, commitments, people, timing and evidence. [External Dependencies](./external-dependencies.md), [Deliverable Systems](./deliverable-systems.md) and [Deliverables](./deliverables.md) become useful when the service reaches beyond its source code into providers, distinct systems, data, content, trust and support. [Domains and Capabilities](./domains-and-capabilities.md), [Logical Deployment Modules](./ldms.md), [Logical Layers](./logical-layers.md) and [Logical Building Blocks](./logical-building-blocks.md) help place implementation responsibility. [Patterns](./patterns.md) gives names to recurring design responses, while [Storage Types](./storage-types.md) helps when physical information storage is part of the decision.
...
The companion [checklists](../checklists/readme.md) turn the explanations into prompts for design and review. The documents explain the reasoning; the checklists help a team remember to apply it. When a catalogue question broadens into the whole delivered outcome, return to [Deliverables](../../../deliverables/readme.md) or the [Engineering for Humans](../readme.md) rather than treating the catalogue as a separate world.
