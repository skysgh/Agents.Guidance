...
The smallest pattern language that makes the problem clearer is usually the most useful. Separation of Concerns, High Cohesion and Low Coupling can test the boundary. DDD is useful when domain meaning and rules need protection; OOP, GRASP and SOLID help place and separate responsibilities in code; GoF patterns help when a recurring object collaboration is present; architectural patterns help when larger boundaries need a known relationship.
