...
These routes make those differences visible without requiring a separate repository, deployment or team for every folder. The [Deliverable Systems](../reference/catalogues/deliverable-systems.md) catalogue remains the canonical description of the systems, their boundaries and their relationships.
...
- [Human Systems Boundary Migration Plan](../../.agent-work/plans/SYSTEMS-BOUNDARY-MIGRATION-PLAN.md)
- [Deliverable Systems](../reference/catalogues/deliverable-systems.md)
- [Delivery Guidance](../delivery/readme.md)
- [A Short Way Into the Guidance](../orientation/ways-into-guidance.md)
