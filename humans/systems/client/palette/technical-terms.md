...
The client implementation vocabulary now lives in [Client Implementation Vocabulary](../implementation-vocabulary.md). This page remains temporarily so older links reach the canonical client-system route.
