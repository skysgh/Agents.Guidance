...
The relationship map now lives in the [Client UX Palette](../ux-palette.md#the-relationship-map). This page remains temporarily so older links reach the canonical client-system catalogue.
