...
Read [Logical Layers](../../reference/catalogues/logical-layers.md), [Logical Building Blocks](../../reference/catalogues/logical-building-blocks.md), [Contracts](./contracts.md) and [LDM Layers and Contents](../service/layers.md) together when deciding whether a physical property or type belongs in the logical model.
