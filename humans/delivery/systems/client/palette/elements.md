...
The element catalogue now lives in the [Client UX Palette](../ux-palette.md). This page remains temporarily so older links reach the canonical client-system catalogue.
