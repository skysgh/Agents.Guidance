...
The broader [Sites, Flows, Views and Components](../../../shared/reference/catalogues/sites-flows-views-components.md) catalogue explains how sites, flows, views and components relate to responsibilities and capabilities. This palette gives the client developer a more focused vocabulary for the visible experience.
...
- [Front-end Developer Guidance](../../../stakeholders/deliverers/developers/front-end.md)
