...
Each perspective is valid, but none is the whole delivery. The [Stakeholder Guidance](../stakeholders/readme.md) explains these contributions and the handoffs between them. The [Human Guidance](../readme.md) provides the wider explanation, examples and shared meaning around the roles and structures.
