...
Each perspective is valid, but none is the whole delivered outcome. [Stakeholders](../stakeholders/readme.md) explains these contributions and the handoffs between them. [Engineering for Humans](../readme.md) provides the wider explanation, examples and shared meaning around the roles and structures.
