...
The [Deliverables catalogue](../../shared/reference/catalogues/deliverables.md) describes documentation as part of the wider delivered outcome. The [Human Documentation Writing Style](../../../.agent-work/documentation/writing-style.md) explains how human-facing material should introduce meaning, terminology and consequences. The [Documentation Register](../../maintenance/documentation-register.md) records significant changes to this repository's material; it is not a substitute for a project's own documentation set.
...
This material introduces documentation as a delivery responsibility. The catalogue and checklists provide detailed reference surfaces, and project teams remain responsible for producing the documentation their outcome requires.
