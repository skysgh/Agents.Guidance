...
The team has reused one word, but the meanings have different owners, lifecycles and security consequences. A system role is not automatically a real-world authority, and a software component's role is not a human permission.
