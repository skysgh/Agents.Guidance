...
Dependable delivery becomes easier when people can recognise the problem they are facing, understand the responsibility involved and see the next decision clearly. This folder explains the foundations behind that way of working: why systems become difficult to change, why boundaries and dependencies need attention before construction, and how different people contribute to one dependable design.

[A Short Way Into the Guidance](./ways-into-guidance.md) is available when the vocabulary is new. It begins with stories and questions, then explains when catalogues and checklists become useful.
...
If this is your first visit, [The Current State](./current-state.md) shows the familiar ways systems become difficult to change. [The Structure Before the Feature](./the-structure-before-the-feature.md) explains why a little dependable structure can make later work easier, and [What This Guidance Gives](./what-this-guidance-gives.md) shows how different people contribute to the same design. Those pages form a connected explanation, but you can also move directly to the route that matches the work in front of you and return to the other questions when they become relevant.
...
- [Guidance for Tech Leads](./guidance-for-tech-leads.md) explains how technical leads translate architecture maps into boundaries, readiness, delivery slices and evidence.
...
- [Guidance for System Design Architects](./guidance-for-system-design-architects.md) explains how system design architects map interfaces, dependencies and downstream obligations across the whole service landscape.
...
Together, these pages move from recognising a delivery problem to understanding structure, contribution and construction choice. The other pages answer narrower questions when one of those foundations becomes relevant.
