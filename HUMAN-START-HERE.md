...
A team is more likely to use guidance when it recognises the problem it is meant to solve. Start with [the current state and recurring failure patterns](./HUMAN-CURRENT-STATE.md), then read [what the guidance gives each stakeholder](./HUMAN-WHAT-GUIDANCE-GIVES.md).

After that, use the [developer orientation](./conventions/developers-need-to-know.md) for the practical mental model and the [work instructions](./conventions/.md) to select the detailed conventions relevant to a task.
...
- [Current state and recurring failure patterns](./HUMAN-CURRENT-STATE.md)
- [What the guidance gives each stakeholder](./HUMAN-WHAT-GUIDANCE-GIVES.md)
- [YAGNI versus WGF](./HUMAN-YAGNI-VERSUS-WGF.md)
...
- [Development Constraints](./conventions/constraints.md)
- [Vertical Slices](./conventions/slices.md)
- [Horizontal Flows](./conventions/flows.md)
- [Startup and Discovery](./conventions/startup.md)
